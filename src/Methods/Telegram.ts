...
import { Raw, Helpers, type Readable,
  type Files } from '../platform.deno.ts';
import type { Snake } from '../Client/index.ts';
import { getMessages, sendMessage, sendMessageParams, sendDocument, sendDocumentParams } from './Messages/index.ts';
...
export class Telegram extends TLObject {
  ...
  */
  sendDocument(chatId:bigint | string, document: string | Buffer | Readable | Files.File, more?: sendDocumentParams){
